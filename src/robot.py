    ...
    def createObjects(self):
        ...
        self.modules = SwerveModuleList(
            ...
            SwerveModule(
                ...
                SwerveModuleConfig(
                    0, KS=3, KV=0.3, KA=0.12, KP_DRIVE=0.1, KI_DRIVE=0,
            ...
            SwerveModule(
                ...
                SwerveModuleConfig(
                    1, KS=3, KV=0.3, KA=0.12, KP_DRIVE=0.1, KI_DRIVE=0,
                    KD_DRIVE=0.05, KP_TURN=0.7, KI_TURN=0.1, KD_TURN=0.01
                )
            ),  # Front-Right
            SwerveModule(
                ...
                SwerveModuleConfig(
                    2, KS=3, KV=0.3, KA=0.12, KP_DRIVE=0.1, KI_DRIVE=0,
                    KD_DRIVE=0.05, KP_TURN=0.7, KI_TURN=0.1, KD_TURN=0.01
                )
            ),  # Rear-Left
            SwerveModule(
                ...
                SwerveModuleConfig(
                    3, KS=3, KV=0.3, KA=0.12, KP_DRIVE=0.1, KI_DRIVE=0,
                    KD_DRIVE=0.05, KP_TURN=0.7, KI_TURN=0.1, KD_TURN=0.01
                )
            )  # Rear-Right
        )
